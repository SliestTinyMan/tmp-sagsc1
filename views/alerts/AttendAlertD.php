      ...
      var cmaplng;
        ...
        google.maps.event.addDomListener(window, 'load', initialize);
                ...
                function ajax_update() {
                    ...
                    $.ajax({
                        data:  parametros,
                        url:   '?action=updalertdd&tid=<?php echo $_SESSION['tid']; ?>&t=1a',
                        type:  'post',
                        beforeSend: function () {
                        ...
                        complete: function (data) {
                            ...
                            window.location='/?action=dale&tid=<?php echo $_SESSION['tid'];?>';
                        }
                    });
                }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="?action=dale&tid=<?php echo $_SESSION['tid']; ?>">DERIVADOS</a>
                    </li>
                    <li>
